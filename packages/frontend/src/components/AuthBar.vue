    ...
    <div class="absolute top-4 right-4">
        ...
        <div v-else-if="user">
            <div class="flex items-center space-x-2">
                ...
                <span>{{ user.name }}</span>
                <a href="https://api.short.pctester.cl/auth/logout">
        ...
        <div v-else>
            <a href="https://api.short.pctester.cl/auth/google">
...
onMounted(async () => {
    ...
    try {
        const res = await fetch('https://api.short.pctester.cl/auth/me', {
            credentials: 'include',
            method: 'GET',
            headers: {
...
<style scoped>
/* Opcional: estilos para la imagen del usuario */
</style>